...
public class GoogleTranslateActivity {
    ...
    private String key = "AIzaSyCQjThU9XZaglVH6jBPRtCU1MSoazlTeuQ";
    ...
    public static void main(String[] args) {
        ...
        GoogleTranslateActivity translator = new GoogleTranslateActivity("AIzaSyCQjThU9XZaglVH6jBPRtCU1MSoazlTeuQ"); // TODO change API Key
